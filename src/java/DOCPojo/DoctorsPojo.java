...
public class DoctorsPojo {
    ...
    /**
     * @param con_fee the con_fee to set
     */
    ...
    /**
     * @param available_from the available_from to set
     */
    ...
    /**
     * @param available_to the available_to to set
     */
